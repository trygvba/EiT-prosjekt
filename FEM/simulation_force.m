...
for i=2:steps
      ...
      U(:,i) = K2*(U(:,i-1)+dt*v+0.25*dt^2*K1*U(:,i-1)+0.25*dt^2*(M\(f_vec(p_new,tri,plateForce2(t+dt,omega,OLT,f),plateDisp(t+dt)) +f_vec(p_new,tri,plateForce2(t,omega,OLT,f),plateDisp(t)))));
