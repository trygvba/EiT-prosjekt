...
for k=1:Np
    ...
    for alpha=1:4
        ...
        for beta = 1:4
            ...
            A(i1,j1) = A(i1,j1)+T*a1*Cp*b1;
            A(i1,j2) = A(i1,j2)+T*a1*Cp*b2;
            A(i1,j3) = A(i1,j3)+T*a1*Cp*b3;
            A(i2,j1) = A(i2,j1)+T*a2*Cp*b1;
            A(i2,j2) = A(i2,j2)+T*a2*Cp*b2;
            A(i2,j3) = A(i2,j3)+T*a2*Cp*b3;
            A(i3,j1) = A(i3,j1)+T*a3*Cp*b1;
            A(i3,j2) = A(i3,j2)+T*a3*Cp*b2;
            A(i3,j3) = A(i3,j3)+T*a3*Cp*b3;
...
for k=(Np+1):N
    ...
    for alpha=1:4
        ...
        for beta = 1:4
            ...
            A(i1,j1) = A(i1,j1)+T*a1*Cs*b1;
            A(i1,j2) = A(i1,j2)+T*a1*Cs*b2;
            A(i1,j3) = A(i1,j3)+T*a1*Cs*b3;
            A(i2,j1) = A(i2,j1)+T*a2*Cs*b1;
            A(i2,j2) = A(i2,j2)+T*a2*Cs*b2;
            A(i2,j3) = A(i2,j3)+T*a2*Cs*b3;
            A(i3,j1) = A(i3,j1)+T*a3*Cs*b1;
            A(i3,j2) = A(i3,j2)+T*a3*Cs*b2;
            A(i3,j3) = A(i3,j3)+T*a3*Cs*b3;
